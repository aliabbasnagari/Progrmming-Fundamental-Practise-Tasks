...
int main()
{
    ...
    do
    {
        ...
        const int SIZE = (noInst + 10); // Size of array with safe margin
        mySIZE = SIZE; // Store size to be used outside of loop
        takenInsta = 0; // number of Total installments

        // Declaring arrays 1D and 2D
        float amounts[2][SIZE], penalty[SIZE] = {0}, balance[SIZE]  = {0};
        int noDays[SIZE] = {0};
        int days[2][SIZE], months[2][SIZE], years[2][SIZE];
